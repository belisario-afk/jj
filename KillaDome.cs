            ...
            private void ShowLoadoutsTab(CuiElementContainer container, BasePlayer player)
            {
                ...
                for (int i = 0; i < availableSkins.Length; i++)
                {
                    ...
                    container.Add(new CuiLabel
                    {
                        ...
                        RectTransform = { AnchorMin = "0.05 0.30", AnchorMax = "0.50 0.50" }
                    }, $"SkinCard_{i}");
                ...
                for (int i = 0; i < availableAttachments.Length; i++)
                {
                    ...
                    container.Add(new CuiLabel
                    {
                        ...
                        RectTransform = { AnchorMin = "0.05 0.45", AnchorMax = "0.95 0.85" }
                    }, $"AttCard_{i}");
                    ...
                    {
                        Text = { Text = statusText, FontSize = 8, Align = TextAnchor.UpperLeft, Color = $"{statusColor} 1" },
                        RectTransform = { AnchorMin = "0.05 0.15", AnchorMax = "0.50 0.40" }
                    }, $"AttCard_{i}");
